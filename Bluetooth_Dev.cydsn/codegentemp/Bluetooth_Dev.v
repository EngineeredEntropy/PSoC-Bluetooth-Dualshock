// ======================================================================
// Bluetooth_Dev.v generated from TopDesign.cysch
// 09/16/2017 at 08:22
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("017211d4-2fce-4383-a770-e88281d47931"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("e02508a0-15c7-4f6c-adec-8d496b35a692"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__INT_PIN_net;
	wire [0:0] tmpFB_0__INT_PIN_net;
	wire [0:0] tmpIO_0__INT_PIN_net;
	wire [0:0] tmpINTERRUPT_0__INT_PIN_net;
	electrical [0:0] tmpSIOVREF__INT_PIN_net;

	cy_psoc3_pins_v1_10
		#(.id("f72e1f69-778d-4901-b299-6f3827cde118"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		INT_PIN
		 (.oe(tmpOE__INT_PIN_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__INT_PIN_net[0:0]}),
		  .io({tmpIO_0__INT_PIN_net[0:0]}),
		  .siovref(tmpSIOVREF__INT_PIN_net),
		  .interrupt({tmpINTERRUPT_0__INT_PIN_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__INT_PIN_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

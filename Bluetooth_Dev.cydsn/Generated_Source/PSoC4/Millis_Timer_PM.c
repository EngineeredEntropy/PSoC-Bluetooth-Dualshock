...
static Millis_Timer_BACKUP_STRUCT Millis_Timer_backup;
...
{
    if(0u != (Millis_Timer_BLOCK_CONTROL_REG & Millis_Timer_MASK))
    {
        Millis_Timer_backup.enableState = 1u;
    }
    else
    {
        Millis_Timer_backup.enableState = 0u;
    }
...
void Millis_Timer_Wakeup(void)
{
    ...
    if(0u != Millis_Timer_backup.enableState)
    {
        Millis_Timer_Enable();
    }
}
